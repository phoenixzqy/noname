        ...
        page2.reset = function(name) {
          ...
          if (lib.extensionPack[name]) {
            ...
            for (var i2 in page2.content.pack.character) {
              var file = i2 + ".jpg";
              var loadImage = function(file2, data) {
                var img = new Image();
                ...
                img.onload = function() {
                  ...
                  canvas.toBlob(function(blob) {
                    ...
                    fileReader.onload = function(e) {
                      page2.content.image[file2] = e.target.result;
                    };
                  ...
                  window.resolveLocalFileSystemURL(nonameInitialized + "extension/" + name, function(entry) {
                    entry.getFile(file, {}, function(fileEntry) {
                      fileEntry.file(function(fileToLoad) {
                        var fileReader = new FileReader();
                        fileReader.onload = function(e) {
                          page2.content.image[file] = e.target.result;
                        };
          ...
          if (lib.extensionPack[name]) {
            ...
            for (var i2 in page2.content.pack.card) {
              ...
              if (game.readFile) {
                ...
                game.getDB("image", `extension-${name}:${file}`).then((value) => {
                  createButton(i2, value, fullskin);
                  loadImage(file, value);
                });
              }
            }
      ...
      var dash4 = (function() {
        ...
        page2.reset = function(name) {
          ...
          if (lib.extensionPack[name]) {
            ...
            for (var i in page2.content) {
              dashes[i].node.code = page2.content[i] || "";
            }
          } else {
          ...
          var saveInput = function(view) {
            ...
            try {
              if (["arenaReady", "content", "prepare", "precontent"].includes(link)) {
                var { func: func2 } = security.exec2(`func = ${resultCode}`);
            ...
            page2.content[link] = resultCode;
            delete window.saveNonameInput;
          };
          container.code = str;
          dash.node = container;
          dash.saveInput = saveInput;
          page2.content[link] = str;
        };
        var clickCode = function() {
          var node2 = this.node;
          ui.window.classList.add("shortcutpaused");
          ui.window.classList.add("systempaused");
          ui.window.appendChild(node2);
          ui.create.editor2(node2, {
            language: "javascript",
            value: node2.code,
        ...
        page2.content = {};
        createCode("辅", "辅助代码", page2, clickCode, "arenaReady", "function(){\n    \n}\n\n/*\n函数执行时机为游戏界面创建之后\n导出时本段代码中的换行、缩进以及注释将被清除\n*/");
        createCode("主", "主代码", page2, clickCode, "content", "function(config,pack){\n    \n}\n\n/*\n函数执行时机为游戏数据加载之后、界面加载之前\n参数1扩展选项（见选项代码）；参数2为扩展定义的武将、卡牌和技能等（可在此函数中修改）\n导出时本段代码中的换行、缩进以及注释将被清除\n*/");
        createCode("预", "预备代码", page2, clickCode, "prepare", "function(){\n    \n}\n\n/*\n函数执行时机为游戏扩展全部加载之后\n导出时本段代码中的换行、缩进以及注释将被清除\n*/");
        createCode("启", "启动代码", page2, clickCode, "precontent", "function(){\n    \n}\n\n/*\n函数执行时机为游戏数据加载之前，联机模式亦可加载\n除添加模式外请慎用\n导出时本段代码中的换行、缩进以及注释将被清除\n*/");
        createCode("选", "选项代码", page2, clickCode, "config", 'config={\n    \n}\n\n/*\n示例：\nconfig={\n    switcher_example:{\n        name:"示例列表选项",\n        init:"3",\n     	  item:{"1":"一","2":"二","3":"三"}\n    },\n    toggle_example:{\n        name:"示例开关选项",\n        init:true\n    }\n}\n此例中传入的主代码函数的默认参数为{switcher_example:"3",toggle_example:true}\n导出时本段代码中的换行、缩进以及注释将被清除\n*/');
        createCode("帮", "帮助代码", page2, clickCode, "help", 'help={\n    \n}\n\n/*\n示例：\nhelp={\n    "帮助条目":"<ul><li>列表1-条目1<li>列表1-条目2</ul><ol><li>列表2-条目1<li>列表2-条目2</ul>"\n}\n帮助内容将显示在菜单－选项－帮助中\n导出时本段代码中的换行、缩进以及注释将被清除\n*/');
        return page2;
      })();
